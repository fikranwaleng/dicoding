package com.submissionfikran.makanankhasindonesia.adapter;
...
import com.submissionfikran.makanankhasindonesia.Makanan;
import com.submissionfikran.makanankhasindonesia.R;
...
public class ListMakananAdapter extends RecyclerView.Adapter<ListMakananAdapter.ListViewHolder>  {
    ...
    public void onBindViewHolder(@NonNull ListViewHolder listViewHolder, int i) {
        ...
        listViewHolder.tvLokasi.setText(makanan.getLokasi_makanan());
        listViewHolder.tvKomposisi.setText(makanan.getKomposisi_makanan());
    ...
    class ListViewHolder extends RecyclerView.ViewHolder {
        ImageView imgPhoto;
        TextView tvName, tvDetail, tvLokasi, tvKomposisi;
        ...
        ListViewHolder(View itemView) {
            ...
            tvKomposisi = itemView.findViewById(R.id.tv_item_komposisi);
        }
    }
